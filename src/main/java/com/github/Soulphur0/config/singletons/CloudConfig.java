...
public class CloudConfig {
  ...
  // $ Config updater
  // € Updates are done via command, a packet is sent to the client with the new
  // settings.
  ...
  public static void updateGeneralConfig(ClientPlayerEntity player, String settingName, String value) {
    if (player != null) {
      switch (settingName) {
  ...
  // ? Updates a specific setting with the provided value.
  // ¿ Called in the EanClientPacketHandler class' processClientSettings method.
  public static void updateCloudLayerConfig(ClientPlayerEntity player, String settingName, String layerNumber,
      String value) {
        ...
        case "altitude" -> {
          ...
          try {
            ...
            if (layerNumber.equals("all")) {
              ...
              notification = "Set altitude of layer " + layerNumber + " to "
        ...
        case "verticalRenderDistance" -> {
          ...
          try {
            ...
            if (layerNumber.equals("all")) {
              ...
              CloudConfig.writeToDisk();
              notification = "Set vertical render distance of layer " + layerNumber + " to "
        ...
        case "lodRenderDistance" -> {
          ...
          try {
            ...
            if (layerNumber.equals("all")) {
              ...
              CloudConfig.writeToDisk();
              notification = "Set LOD render distance of layer " + layerNumber + " to "
                  + CloudConfig.cloudLayers[layer - 1].getLodRenderDistance() + " blocks.";
            }
        ...
        case "opacity" -> {
          ...
          try {
            ...
            if (layerNumber.equals("all")) {
              ...
              CloudConfig.writeToDisk();
              notification = "Set cloud opacity of layer " + layerNumber + " to "
        ...
        case "speed" -> {
          ...
          try {
            ...
            if (layerNumber.equals("all")) {
              ...
              CloudConfig.writeToDisk();
              notification = "Set speed of layer " + layerNumber + " to x"
  ...
  public static void readFromDisk() {
    ...
    try {
      ...
      // If the file doesn't exist yet, create instance with default values and write
      // it to disk.
  ...
  // € Always called in conjunction with the methods that read and write the
  // config.

  // ? Reads the cloud layers from disk, if not present, generates the default
  // preset and saves it to disk.
  public static void readCloudLayers() {
    ...
    Gson gson = new Gson();
    Type type = new TypeToken<List<CloudLayer>>() {
    }.getType();
  ...
  // ? Called every time the config is updated via command (by the writeConfig
  // method).
  ...
  // € Each method generates a different cloud preset, names are registered in an
  // enum at the end.
